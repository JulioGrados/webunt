...
import { useSession, useStateData } from '../../../hooks'
...
import { PerfilBody } from '../styles/style'
        ...
        <Form>
          ...
          <PerfilBody>
              ...
              <FormDouble>
                ...
                {
                    loggedUser && loggedUser.rol && loggedUser.rol === 'emprendedor' && (
                        <>
